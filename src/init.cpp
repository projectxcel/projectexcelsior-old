...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/projectexcelsior-project/projectexcelsior>";
    const std::string URL_WEBSITE = "<https://projectexcelsior.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("ProjectExcelsior version %s\n", FormatFullVersion());
}
