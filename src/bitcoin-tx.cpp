...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s projectexcelsior-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  projectexcelsior-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded projectexcelsior transaction") + "\n" +
              "  projectexcelsior-tx [options] -create [commands]   " + _("Create hex-encoded projectexcelsior transaction") + "\n" +
              "\n";
