...
#if defined(NDEBUG)
# error "ProjectExcelsior cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "ProjectExcelsior Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s XCL additional fees, %d delta bytes\n",
