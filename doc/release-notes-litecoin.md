ProjectExcelsior Core version *0.15.1* is now available from:

  <https://download.projectexcelsior.org/projectexcelsior-0.15.1/>
...
A number of changes to the way ProjectExcelsior Core deals with peer connections and invalid blocks
